...
templates["partial.users.jade"] = function anonymous(locals, attrs, escape, rethrow, merge) {
...
buf.push('<li><a');
buf.push(attrs({ 'href':("#!" + (user._id) + "") }, {"href":true}));
buf.push('>' + escape((interp = user.name) == null ? '' : interp) + '  </a></li>');
    }
